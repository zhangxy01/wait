...
function pre_install(){
    ...
    read -p "(默认密码是ben123):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="ben123"
    echo
    echo "---------------------------"
    ...
    read -p "(默认端口: 80):" shadowsocksport1
    [ -z "$shadowsocksport1" ] && shadowsocksport1="80"
...
echo -e "设置第三个远程端口 [1-65535]:"
  read -p "(默认端口: 53):" shadowsocksport3
    [ -z "$shadowsocksport3" ] && shadowsocksport3="53"
echo -e "设置第四个远程端口 [1-65535]:"
    read -p "(默认端口: 138):" shadowsocksport4
    [ -z "$shadowsocksport4" ] && shadowsocksport4="138"
echo -e "设置第五个远程端口 [1-65535]:"
    read -p "(默认端口: 137):" shadowsocksport5
    [ -z "$shadowsocksport5" ] && shadowsocksport5="137"
    ...
    if [ $? -eq 0 ]; then
        if [ $shadowsocksport -ge 1 ] && [ $shadowsocksport -le 65535 ]; then
            echo
            echo "---------------------------"
            echo "您设置的端口: ${shadowsocksport1}、${shadowsocksport2}、${shadowsocksport3}、${shadowsocksport4}、${shadowsocksport5}"
            echo "---------------------------"
            echo
            break
        else
...
function install_ss(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo -e "远程端口: \033[41;37m ${shadowsocksport1}、${shadowsocksport2}、${shadowsocksport3}、${shadowsocksport4}、${shadowsocksport5} \033[0m"
        ...
        echo "基于shadowsocks.be的脚本修改多端口版"
        echo "By: 奔放网Loser"
        echo
        echo "奔放网http://ben.wap.sg"
        echo
    else
