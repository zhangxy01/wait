...
function pre_install(){
    ...
    while true
    do
    echo -e "设置ShadowsocksR1远程端口 [1-65535]:"
...
function download_files(){
    ...
    if ! wget --no-check-certificate -O libsodium-1.0.10.tar.gz https://git.oschina.net/ben123pw/BFW/raw/master/ss/libsodium-1.0.10.tar.gz; then
